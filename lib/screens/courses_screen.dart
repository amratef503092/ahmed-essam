...
import 'package:three_m_physics/widgets/course_list_item.dart';
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (pageDataType == CoursesPageData.Category) {
        ...
        Provider.of<Courses>(context)
            .filterCourses(selectedCategory: "all"  , selectedLanguage: "all" , 
            selectedLevel: "all" , selectedPrice: "all" ,selectedRating: "all"
            ).then((_) {
          setState(() {
            _isLoading = false;
          });
