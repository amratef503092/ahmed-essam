...
import 'package:three_m_physics/widgets/my_bundle_grid.dart';
import 'package:three_m_physics/widgets/my_course_grid.dart';
...
class MyCoursesScreen extends StatefulWidget {
  const MyCoursesScreen({super.key, this.setSafeArya = false});
  final bool setSafeArya;
  @override
            ...
            return Consumer<MyCourses>(
              builder: (context, myCourseData, child) => AlignedGridView.count(
                ...
                itemBuilder: (ctx, index) {
                  print( myCourseData.items[index].enableDripContent.toString() + "Amr Atef Goda");
                  return MyCourseGrid(
