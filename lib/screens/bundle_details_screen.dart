...
import 'package:three_m_physics/models/bundle_details_model.dart';
...
import 'package:three_m_physics/widgets/course_grid.dart';
                      ...
                      itemBuilder: (ctx, index) {
                        return CourseGrid(
                          course: Course(
                            ...
                            id: bundles[0].bundleCourses![index].id.toString(),
                            thumbnail:
                                bundles[0].bundleCourses![index].thumbnail ??
                                    "",
                            instructor: bundles[0]
                                    .bundleCourses![index]
                                    .instructorName ??
                                "",
                            instructorImage: bundles[0]
                                    .bundleCourses![index]
                                    .instructorImage ??
                                "",
                            price: bundles[0].bundleCourses![index].price ?? "",
                            rating:
                                bundles[0].bundleCourses![index].rating ?? 0,
