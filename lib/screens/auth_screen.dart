...
import 'package:three_m_physics/providers/auth.dart';
import 'package:three_m_physics/screens/forgot_password_screen.dart';
import 'package:three_m_physics/screens/signup_screen.dart';
import 'package:three_m_physics/screens/tabs_screen.dart';
import 'package:three_m_physics/widgets/string_extension.dart';
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (userDetails.validity == 1) {
      ...
      if (userDetails.deviceVerification != null) {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            inReview? SizedBox.shrink():  Padding(
              padding: const EdgeInsets.only(left: 15, right: 15),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Text(
                    'لا تريد تسجيل الدخول? ',
                    style: TextStyle(
                      color: kTextLowBlackColor,
                      fontSize: 15,
                      fontWeight: FontWeight.w400,
