...
class SharedPreferenceHelper {
 ...
 Future<bool> setPhoneNumper(String phoneNumber) async {
    final pref = await SharedPreferences.getInstance();
    return pref.setString(userPref.phone.toString(), phoneNumber);
  }

  Future<String?> getPhoneNumber() async {
    final pref = await SharedPreferences.getInstance();
    return pref.getString(userPref.phone.toString());
  }
