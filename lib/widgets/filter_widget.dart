...
import 'package:three_m_physics/widgets/coubtry_drob_down_menu.dart';
    ...
    try {
      if (_selectedSubCat != null) {
         await Provider.of<Courses>(context, listen: false).filterCourses(
           selectedCategory:  _selectedSubCat,
                          ...
                          children: <Widget>[
                            ...
                            Card(
                              ...
                              child: Padding(
                                padding:
                                    const EdgeInsets.symmetric(horizontal: 10),
                                child:  CountriesWidget(onChanged: 
                                (value)
                                {
                                  setState(() {
                                    _selectCountry = value.toString();
                                  });
                                },)
